...
class FasterWhisperPipeline(Pipeline):
    ...
    def __init__(
        ...
        model,
        vad,
        vad_params: dict, device = torch.device("cuda"),
    ...
    def preprocess(self, audio):
        audio = audio['inputs']
        model_n_mels = 128#self.model.feat_kwargs.get("feature_size")
    ...
    def _forward(self, model_inputs):
        outputs = generate_segment_batched(self.model, model_inputs['inputs'])#, self.tokenizer, self.options)
        return {'text': outputs}
